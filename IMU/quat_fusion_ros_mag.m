...
while(1)
    ...
    Jh1 =2*g(3)*[-q_k(3) q_k(4) -q_k(1) q_k(2);
    ...
    Jh_ga =2*g(3)*[-q_k_gyro_accel(3) q_k_gyro_accel(4) -q_k_gyro_accel(1) q_k_gyro_accel(2);
    ...
    tform_g.Header.Stamp = rostime('now');
    ...
    tform_ga.Header.Stamp = rostime('now');
    ...
    tform_m.Header.Stamp = rostime('now');
